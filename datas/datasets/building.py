...
class Building(BaseDataset):
    ...
    def get_image_list(self):
        ...
        for city in ["Vegas", "Paris", "Shanghai", "Khartoum"]:
            ...
            train_image_list_city = image_list[:fold_size * self.fold] + image_list[fold_size * (self.fold + 1):]
            ...
            if city == "Vegas":
                assert image_list[0] == f"{self.data_dir}/building/train/Vegas_1000_sat.jpg", \
                    f"`image_list[0]`: {image_list[0]} is not {self.data_dir}/building/train/Vegas_1000_sat.jpg"

                assert len(train_image_list_city) == 3081, \
                    f"`len(train_image_list_city)`: {len(train_image_list_city)} does not equal to 3081"

                assert len(val_image_list_city) == 770, \
                    f"`len(val_image_list_city)`: {val_image_list_city} does not equal to 770"
            elif city == "Paris":
                assert image_list[0] == f"{self.data_dir}/building/train/Paris_1000_sat.jpg", \
                    f"`image_list[0]`: {image_list[0]} is not {self.data_dir}/building/train/Paris_1000_sat.jpg"

                assert len(train_image_list_city) == 919, \
                    f"`len(train_image_list_city)`: {len(train_image_list_city)} does not equal to 919"

                assert len(val_image_list_city) == 229, \
                    f"`len(val_image_list_city)`: {val_image_list_city} does not equal to 229"
            elif city == "Shanghai":
                assert image_list[0] == f"{self.data_dir}/building/train/Shanghai_1001_sat.jpg", \
                    f"`image_list[0]`: {image_list[0]} is not {self.data_dir}/building/train/Shanghai_1001_sat.jpg"

                assert len(train_image_list_city) == 3666, \
                    f"`len(train_image_list_city)`: {len(train_image_list_city)} does not equal to 3666"

                assert len(val_image_list_city) == 916, \
                    f"`len(val_image_list_city)`: {val_image_list_city} does not equal to 916"
            elif city == "Khartoum":
                assert image_list[0] == f"{self.data_dir}/building/train/Khartoum_1001_sat.jpg", \
                    f"`image_list[0]`: {image_list[0]} is not {self.data_dir}/building/train/Khartoum_1001_sat.jpg"

                assert len(train_image_list_city) == 810, \
                    f"`len(train_image_list_city)`: {len(train_image_list_city)} does not equal to 810"

                assert len(val_image_list_city) == 202, \
                    f"`len(val_image_list_city)`: {val_image_list_city} does not equal to 202"

        assert len(train_image_list) == 8476, \
            f"`len(train_image_list)`: {len(train_image_list)} does not equal to 8476"

        assert len(val_image_list) == 2117, \
            f"`len(val_image_list)`: {len(val_image_list)} does not equal to 2117"
