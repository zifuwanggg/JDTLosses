...
class Mapillary(BaseDataset):
    def __init__(self,
                 ...
                 reduce_panoptic_zero_label=True,
                 image_prefix="/images/",
                 image_suffix=".jpg",
    ...
    def get_panoptic_file(self, label_file):
        panoptic_file = label_file.replace("/labels/", "/panoptic/")
        panoptic_file = panoptic_file.replace(self.label_suffix, ".png")
    ...
    def get_image_list(self):
        ...
        assert len(train_image_list) == 18000, \
            f"`len(train_image_list)`: {len(train_image_list)} does not equal to 18000"
    ...
    def get_annos(self):
        ...
        json_file = f"{self.data_dir}/mapillary/{split}/v1.2/panoptic/panoptic_2018.json"
