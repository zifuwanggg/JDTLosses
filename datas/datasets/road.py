...
class Road(BaseDataset):
    ...
    def get_image_list(self):
        image_list = glob(f"{self.data_dir}/road/train/*_sat.jpg")
        image_list.sort()
        ...
        assert image_list[0] == f"{self.data_dir}/road/train/100034_sat.jpg", \
            f"`image_list[0]`: {image_list[0]} is not {self.data_dir}/road/train/100034_sat.jpg"

        assert len(train_image_list) == 4981, \
            f"`len(train_image_list)`: {len(train_image_list)} does not equal to 4981"

        assert len(val_image_list) == 1245, \
            f"`len(val_image_list)`: {len(val_image_list)} does not equal to 1245"
