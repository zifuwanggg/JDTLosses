...
### you mei you ignore index?

def QUBIQ(data_dir, dataset, task):
    print(f"Begin processing QUBIQ-{dataset}-task{task}")
    ...
    print(f"Finish processing QUBIQ-{dataset}-task{task}")