# modified from https://github.com/qubvel/segmentation_models.pytorch/blob/master/segmentation_models_pytorch/encoders/mix_transformer.py
...
class MixVisionTransformerEncoder(MixVisionTransformer, EncoderMixin):
    ...
    def forward(self, x):
        ...
        return [dummy] + self.forward_features(x)[: self._depth - 1]
